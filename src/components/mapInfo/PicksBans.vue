<template>
  <v-container fluid>
    ...
    <v-row>
      <v-col cols="6">
        <v-card class="bg-blue-darken-4" variant="outlined">
         ...
         <v-card-text>
            <v-row>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" label="Ban 1" field="blue_ban_1" :champions="champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" :label="getPlayerName(map.blue_side, map.blue_baron_player)" field="blue_pick_1" :champions="bluePick1Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" label="Ban 2" field="blue_ban_2" :champions="blueBan2Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" :label="getPlayerName(map.blue_side, map.blue_jungle_player)" field="blue_pick_2" :champions="bluePick2Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" label="Ban 3" field="blue_ban_3" :champions="blueBan3Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" :label="getPlayerName(map.blue_side, map.blue_mid_player)" field="blue_pick_3" :champions="bluePick3Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" label="Ban 4" field="blue_ban_4" :champions="blueBan4Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" :label="getPlayerName(map.blue_side, map.blue_dragon_player)" field="blue_pick_4" :champions="bluePick4Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" label="Ban 5" field="blue_ban_5" :champions="blueBan5Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="blue" :map="map" :label="getPlayerName(map.blue_side, map.blue_sup_player)" field="blue_pick_5" :champions="bluePick5Champions" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
      ...
      <v-col cols="6">
        <v-card class="bg-red-darken-4" variant="outlined">
          <v-card-title style="display: flex; justify-content: center">
          ...
          <v-card-text>
            <v-row>
              <v-col cols="6">
                <ChampionField side="red" :map="map" :label="getPlayerName(map.red_side, map.red_baron_player)" field="red_pick_1" :champions="redPick1Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" label="Ban 1" field="red_ban_1" :champions="redBan1Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" :label="getPlayerName(map.red_side, map.red_jungle_player)" field="red_pick_2" :champions="redPick2Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" label="Ban 2" field="red_ban_2" :champions="redBan2Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" :label="getPlayerName(map.red_side, map.red_mid_player)" field="red_pick_3" :champions="redPick3Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" label="Ban 3" field="red_ban_3" :champions="redBan3Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" :label="getPlayerName(map.red_side, map.red_dragon_player)" field="red_pick_4" :champions="redPick4Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" label="Ban 4" field="red_ban_4" :champions="redBan4Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" :label="getPlayerName(map.red_side, map.red_sup_player)" field="red_pick_5" :champions="redPick5Champions" />
              </v-col>
              <v-col cols="6">
                <ChampionField side="red" :map="map" label="Ban 5" field="red_ban_5" :champions="redBan5Champions" />
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
